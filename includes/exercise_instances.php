...
class ExerciseInstances {
    ...
    protected static $table_name="exercise_instances";
    protected static $db_fields = array('id', 'exercise_id', 'day_id', 'exercise_duration', 'order');
    public $id;
    public $exercise_id;
    public $day_id;
    ...
    public static function find_all_by_day_id($my_id=0) {

        return self::find_by_sql("SELECT * FROM ".self::$table_name." WHERE day_id={$my_id}");
